    ...
    return (
      <AuthCard role="student">
        <div className="animate-fade-up flex flex-col items-center justify-center text-center p-8">
          <div className="w-16 h-16 border border-student flex items-center justify-center mb-6 text-student">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="square" strokeLinejoin="miter">
              <path d="M20 6L9 17l-5-5" />
            </svg>
          </div>
          <h2 className="font-serif text-3xl text-graphite mb-2">Access Granted</h2>
          <p className="font-sans text-graphite/70 text-sm">Redirecting to system...</p>
        </div>
      </AuthCard>
    );
  }
      ...
      <div className="animate-fade-up">
        ...
        <div className="mb-12">
          ...
          <p className="font-sans text-graphite/60 text-sm leading-relaxed max-w-sm">
            Join the platform and take your first assessment.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
          ...
          <div className="animate-fade-up stagger-1">
            <label htmlFor="student-reg-name" className="block font-mono text-xs uppercase tracking-widest text-graphite/60 mb-2">
              Full name
            </label>
            <input
              id="student-reg-name"
          ...
          <div className="animate-fade-up stagger-2">
            <label htmlFor="student-reg-email" className="block font-mono text-xs uppercase tracking-widest text-graphite/60 mb-2">
              Email address
            </label>
            <input
          ...
          <div className="animate-fade-up stagger-3">
            <label htmlFor="student-reg-password" className="block font-mono text-xs uppercase tracking-widest text-graphite/60 mb-2">
              Password
            </label>
          ...
          <div className="animate-fade-up stagger-4">
            <label htmlFor="student-reg-confirm" className="block font-mono text-xs uppercase tracking-widest text-graphite/60 mb-2">
              Confirm password
            </label>
            <input
              ...
              className={`w-full h-12 px-0 bg-transparent border-b text-graphite font-sans text-base outline-none transition-colors focus:ring-0 placeholder:text-graphite/30 ${confirm && confirm !== password
                ...
                : "border-grid focus:border-student"
                }`}
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className={`animate-fade-up stagger-5 mt-8 w-full h-14 flex items-center justify-between px-6 font-mono text-xs uppercase tracking-widest transition-all duration-300 ${loading
